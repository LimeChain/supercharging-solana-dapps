...
export const defaultClusters: Cluster[] = [
  ...
  {
    name: "mainnet-beta",
    endpoint: "https://api.mainnet-beta.solana.com", // Public RPC (rate limited)
    network: ClusterNetwork.Mainnet,
  },
  {
    name: "mainnet-beta-alchemy",
    endpoint: `https://solana-mainnet.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ALCHEMY_API_KEY}`,
    network: ClusterNetwork.Mainnet,
  },
];
